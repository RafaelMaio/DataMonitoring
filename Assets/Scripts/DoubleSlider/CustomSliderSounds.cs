...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    /// </summary>
    [RequireComponent(typeof(CustomPinchSlider))]
    ...
    public class CustomSliderSounds : MonoBehaviour
    {
        ...
        private CustomPinchSlider slider;
        ...
        private void Start()
        {
            ...
            slider = GetComponent<CustomPinchSlider>();
        ...
        private void OnValueUpdated(CustomSliderEventData eventData)
        {
        ...
        private void OnInteractionEnded(CustomSliderEventData arg0)
        {
            isInteracting = false;
        ...
        private void OnInteractionStarted(CustomSliderEventData arg0)
        {
            isInteracting = true;
